...
class LastPageState extends State<LastPage> {
  ...
  void initState() {
    ...
    if (widget.statusType == 'Unhappy') {
      ...
      msg = 'We are so sorry. What went wrong?';
      feedbackList = [
        Feedback('Not helpful nor thoughful', false),
        Feedback('Slow and  unresponsive', false),
      ...
      msg = 'Neutral is just okay. Why is that?';
      feedbackList = [
      ...
      msg = 'Awesome! What does it for you?';
      feedbackList = [
