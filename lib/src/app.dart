            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text(
                        'When you need help or have concerns related with our product, how satisfied are you with our customer support\'s performance?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 213.0,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Expanded(
                      child: Center(
                          child: new Image(
                            image: new AssetImage("images/tag.png"),
                  ))),
                  Text(
                    'Your opinion in 2 minutes.',
                    style: TextStyle(
                        color: Colors.blueAccent,
                        fontWeight: FontWeight.bold,
                        fontSize: 30.0),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'By answering this 2 minute survey, you help us make our service even better for you',
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
                    ),
